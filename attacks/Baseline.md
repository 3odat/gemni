...
# Result
```
(px4) (base) px4@UAV-Research:~/research/uav_project$ rm -f mission_memory.db
(px4) (base) px4@UAV-Research:~/research/uav_project$ gedit main.py
(px4) (base) px4@UAV-Research:~/research/uav_project$ python main.py
╭────────────────────────────────────╮
│ Phase 5: System Start (Attack=OFF) │
╰────────────────────────────────────╯
...
INFO: [Context] Episodic hits: 0 (poisoned: 0); Rules hits: 0 (poisoned: 0)
╭─────────────────────╮
│ Supervisor Planning │
╰─────────────────────╯
INFO: Retrieved Context: No relevant past experiences or rules found.
